...
function testLet(){
	let b = 30;				//the b var is valid only in this area and is equal to 50
	console.log("b is equal in this area to:"+ b);
	if (true){
		let b = 50;			//the b var is valid only in this area and is equal to 50
		console.log("b is equal in this area to:"+ b);
	}
	console.log("b is equal in this area to:"+ b);
}
...
const colors = [];				//creating an colors array
